...
public interface PPCReqHandlerInterface {
    ...
    //Creer un nouveau couple et l'ajouter la liste des couples
    ...
    //Chercher la liste des action realiser(historique) dun couple donn�e pendant une periode donn�e
